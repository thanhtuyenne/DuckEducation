        ...
        <div class="contener">
                ...
                <span>
                    <div class="search">
                        <form action="#" method="GET">
                            <button class="icon btn-search " id="searchIcon" type="submit"><img src="${pageContext.request.contextPath}/Resource/img/search.png" alt=""></button>
            ...
            <div class="side-right">
                <div class="option">
                    <nav>
                        <ul class="header_ul">
                            <li><img class="icon" src="${pageContext.request.contextPath}/Resource/img/message.png" alt="">
                                <ul class="drop">
                                    <a href="${pageContext.request.contextPath}/control?button-control=message">
                                        <li>
                                            <img style="width: 40px; padding-right: 10px;" src="https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" />
                                            <div class="text--overflow"> some thing content there, Im handsome guy</div>
                                        </li>
                                    </a>
                                    <a href="${pageContext.request.contextPath}/control?button-control=message">
                                        <li>
                                            <img style="width: 40px; padding-right: 10px;" src="https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" /> <div class="text--overflow"> some thing content there, Im handsome guy</div>
                                        </li>
                                    </a>

                                </ul>
                            </li>
                            <li><img class="icon" src="${pageContext.request.contextPath}/Resource/img/bell.png" alt="">
                                <ul class="drop">
                                    <li>
                                        <img style="width: 40px; padding-right: 10px;" src="https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" /> <div class="text--overflow"> some thing content there, Im handsome guy</div>
                                    </li>
                            ...
                            <li><img class="icon" src="${pageContext.request.contextPath}/Resource/img/setting.png" alt="">
                                <ul class="drop setting">
                                    ...
                                    <a href="${pageContext.request.contextPath}/control?button-control=logout">
                                        <li>
                                            Logout
                                        </li>
                                    </a>
